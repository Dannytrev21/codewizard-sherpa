...
@register_index_freshness_check(IndexName("semgrep"))
def _semgrep_freshness(slice_: dict[str, object], _head: str) -> IndexFreshness:
    """S6-08 — Open/Closed registration in the owning module (not B2)."""
    return compare_versions(slice_, "semgrep", "rule_pack_version")
