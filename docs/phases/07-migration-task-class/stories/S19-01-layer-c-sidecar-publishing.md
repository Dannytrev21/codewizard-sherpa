...
**Attempts:** 1
**Evidence:**
- Files: `src/codegenie/probes/layer_c/{dockerfile,runtime_trace,entrypoint,shell_usage,certificate,sbom,cve}.py`, `src/codegenie/probes/layer_g/semgrep.py`, `tests/fence/test_kernel_frozen.py`, `tests/integration/test_layer_c_sidecar_contract.py`, `docs/get-started.md`, `tests/unit/probes/**`, `tests/golden/probes/**`
- Tests: `tests/integration/test_layer_c_sidecar_contract.py` red→green, `tests/unit/probes/layer_c/test_dockerfile.py`, `tests/unit/probes/layer_c/test_runtime_trace.py`, `tests/unit/probes/layer_g/test_semgrep.py`, `tests/unit/probes/layer_b/test_index_health_probe.py`, `make check`, `make lint-imports`, `make docs`
- Commit: this commit
**Effort:** S
