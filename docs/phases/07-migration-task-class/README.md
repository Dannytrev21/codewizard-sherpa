...
This folder contains the design of record for Phase 7 of the codewizard-sherpa roadmap, plus the artifacts that produced it. The design was synthesized via the multi-agent workflow defined in the `roadmap-phase-designer` skill: three competing single-lens designs, a devil's-advocate critique, and a Graph-of-Thought synthesis.

**Phase scope:** see [`../../roadmap.md`](../../roadmap.md) §"Phase 7 — Add migration task class (Chainguard distroless)".
...
- **Prior phases:**
  ...
  - [`../06-sherpa-state-machine/final-design.md`](../06-sherpa-state-machine/final-design.md)
