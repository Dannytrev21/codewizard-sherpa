...
**Status:** **BLOCKED (2026-05-16)** — vendored grammar binaries under `tools/grammars/` are 68-byte placeholder stubs; cannot proceed to RED/GREEN until either (a) real Linux x86_64 grammars are vendored per `tools/grammars/README.md`, or (b) 02-ADR-0002 is amended to use PyPI grammar packages. Full blocker analysis: [`_attempts/S4-04.md`](_attempts/S4-04.md).
**Effort:** M
