...
**Status:** Done (2026-05-13 — implemented; 22/22 tests green; ruff/mypy --strict clean; chokepoint discipline verified)
**Effort:** S
**Depends on:** S2-01
...
- [x] **AC-1 (public surface, locked).** `src/codegenie/hashing.py` exports exactly three public functions with these signatures and no others:
  ```python
