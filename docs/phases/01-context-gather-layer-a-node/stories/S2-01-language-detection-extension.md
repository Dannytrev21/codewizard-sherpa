...
**Status:** Done — 2026-05-14 (phase-story-executor attempt 1, GREEN). All 13 ACs verified with runtime evidence; 37 affected-slice tests green; full suite 903 passed + 2 pre-existing env-only `lint-imports` failures (documented in S1-05/S1-10 Done); `ruff check` + `ruff format --check` + `mypy --strict src/codegenie` all clean; pre-commit on touched files clean. Attempt log: [`_attempts/S2-01.md`](_attempts/S2-01.md). Implementation: [`src/codegenie/probes/language_detection.py`](../../../../src/codegenie/probes/language_detection.py), [`src/codegenie/schema/probes/language_detection.schema.json`](../../../../src/codegenie/schema/probes/language_detection.schema.json). Tests: [`tests/unit/probes/test_language_detection_extended.py`](../../../../tests/unit/probes/test_language_detection_extended.py), sibling regression tests in [`tests/unit/test_language_detection_probe.py`](../../../../tests/unit/test_language_detection_probe.py) (`test_declared_inputs_additive`, `test_module_import_asserts_error_ids`). Deviations: (1) AC-9 pointer assertion uses jsonschema's dotted `json_path` substring instead of RFC-6901 JSON-Pointer (L-19); (2) `tests/unit/test_schema_validation.py` updated additively for new required slice fields (L-20). Cross-story lessons: L-19, L-20.
**Effort:** S
